...
class Drive {
 ...
 private:
  ...
  struct odom_reference_state {
    pose target_pose = {0.0, 0.0, 0.0};
    ...
    double time = 0.0;
    double distance = 0.0;
    drive_directions drive_direction = fwd;
  };
  odom active_odom_motion = {{0.0, 0.0, ANGLE_NOT_SET}, fwd, 0, shortest};
  std::vector<odom_reference_state> odom_reference_states;
  std::uint32_t odom_reference_start_ms = 0;
  std::uint32_t odom_reference_last_ms = 0;
  double odom_reference_left_vel = 0.0;
  double odom_reference_right_vel = 0.0;
  double odom_reference_prev_cmd_v = 0.0;
  double odom_reference_prev_cmd_omega = 0.0;
